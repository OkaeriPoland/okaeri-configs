...
/**
 * Tests for YAML structure and comment rendering with YamlSnakeYamlConfigurer.
 * 
 * Uses small, focused test configs compared against inline YAML text blocks.
 * MegaConfig E2E tests are in YamlSnakeYamlConfigurerMegaConfigTest.
 */
class YamlSnakeYamlConfigurerStructureTest {
