...
class YamlWalkerTest {
    ...
    void testSimpleKeyValue() {
        ...
        YamlLine nameLine = walker.findLine(ConfigPath.parse("name"));
        ...
        YamlLine ageLine = walker.findLine(ConfigPath.parse("age"));
    ...
    void testNestedObjects() {
        ...
        YamlLine dbLine = walker.findLine(ConfigPath.parse("database"));
        ...
        YamlLine hostLine = walker.findLine(ConfigPath.parse("database.host"));
        ...
        YamlLine portLine = walker.findLine(ConfigPath.parse("database.port"));
    ...
    void testDeeplyNested() {
        ...
        YamlLine valueLine = walker.findLine(ConfigPath.parse("level1.level2.level3.value"));
    ...
    void testSimpleList() {
        ...
        YamlLine item0 = walker.findLine(ConfigPath.parse("items[0]"));
        ...
        YamlLine item1 = walker.findLine(ConfigPath.parse("items[1]"));
        ...
        YamlLine item2 = walker.findLine(ConfigPath.parse("items[2]"));
    ...
    void testListOfObjects() {
        ...
        YamlLine server0Host = walker.findLine(ConfigPath.parse("servers[0].host"));
        ...
        YamlLine server0Port = walker.findLine(ConfigPath.parse("servers[0].port"));
        ...
        YamlLine server1Host = walker.findLine(ConfigPath.parse("servers[1].host"));
        ...
        YamlLine server1Port = walker.findLine(ConfigPath.parse("servers[1].port"));
    ...
    void testMultilineValue() {
        ...
        YamlLine descLine = walker.findLine(ConfigPath.parse("description"));
    ...
    void testValueColumn() {
        ...
        YamlLine shortLine = walker.findLine(ConfigPath.parse("short"));
        assertThat(shortLine.getValueColumn()).isEqualTo(7); // "short: x" -> x at index 7

        YamlLine longerLine = walker.findLine(ConfigPath.parse("longer_key"));
    ...
    void testMixedStructure() {
        ...
        assertThat(walker.findLine(ConfigPath.parse("app"))).isNotNull();
        assertThat(walker.findLine(ConfigPath.parse("app.name"))).isNotNull();
        assertThat(walker.findLine(ConfigPath.parse("app.name")).getValue()).isEqualTo("MyApp");

        assertThat(walker.findLine(ConfigPath.parse("app.servers[0].host"))).isNotNull();
        assertThat(walker.findLine(ConfigPath.parse("app.servers[0].host")).getValue()).isEqualTo("primary.com");

        assertThat(walker.findLine(ConfigPath.parse("app.servers[1].port"))).isNotNull();
        assertThat(walker.findLine(ConfigPath.parse("app.servers[1].port")).getValue()).isEqualTo("443");

        assertThat(walker.findLine(ConfigPath.parse("app.settings.timeout"))).isNotNull();
        assertThat(walker.findLine(ConfigPath.parse("app.settings.timeout")).getValue()).isEqualTo("30");
    }
}
