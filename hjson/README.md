...
Based on [OkaeriPoland/okaeri-hjson](https://github.com/OkaeirPoland/okaeri-hjson), modification of official hjson implementation for java.
...
```groovy
implementation 'eu.okaeri:okaeri-configs-hjson:2.6.4'
```
